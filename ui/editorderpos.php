...
$update_tblinvoice=$pdo->prepare("update tbl_invoice order_date=:orderdate,subtotal=:subtotal,discount=:discount,sgst=:sgst,cgst=:cgst,total=:total,payment_type:payment_type,due=:due,paid=:paid  where  invoice_id=$id");

$update_tblinvoice->bindParam(':orderdate',$txt_orderdate);
$update_tblinvoice->bindParam(':subtotal',$txt_subtotal);
$update_tblinvoice->bindParam(':discount',$txt_discount);
$update_tblinvoice->bindParam(':sgst',$txt_sgst);
$update_tblinvoice->bindParam(':cgst',$txt_cgst);
$update_tblinvoice->bindParam(':total',$txt_total);
$update_tblinvoice->bindParam(':payment_type',$txt_payment_type);
$update_tblinvoice->bindParam(':due',$txt_due);
$update_tblinvoice->bindParam(':paid',$txt_paid);


$$update_tblinvoice->execute();
...
table{border-collapse: collapse; width: px;}
          ...
          <div class="card card-danger card-outline">
              ...
              <div class="card-body">
                ...
                <div class="input-group mb-3">
                  ...
                  <tbody class="detalis" id="itemtable">
                ...
                <div class="input-group">
                  <div class="input-group-prepend">
                    <span class="input-group-text">SUBTOTAL(Peso)</span>
                  </div>
                ...
                <div class="input-group">
                  <div class="input-group-prepend">
                    <span class="input-group-text">DISCOUNT(Peso)</span>
                  </div>
                ...
                <div class="input-group">
                  <div class="input-group-prepend">
                    <span class="input-group-text">SGST(Peso)</span>
                  </div>
                ...
                <div class="input-group">
                  <div class="input-group-prepend">
                    <span class="input-group-text">CGST(Peso)</span>
                  </div>
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control form-control-lg total" value="<?php echo $total;?>"id="txttotal" name="txttotal"  readonly >
                  <div class="input-group-append">
                    <span class="input-group-text">₱</span>
                  </div>
                </div>
                ...
                <div class="icheck-success d-inline">
                  ...
                  <div class="input-group">
                  <div class="input-group-prepend">
                    <span class="input-group-text">DUE(Peso)</span>
                  </div>
                ...
                <div class="input-group">
                  <div class="input-group-prepend">
                    <span class="input-group-text">PAID(Peso)</span>
                  </div>
...
success:function(data){
  ...
  if (jQuery.inArray(data["product_id"],productarr)!== -1) {
    ...
    function addrow(product_id,product_name,qty,rate,saleprice,stock,barcode){
      ...
      '<td style="text-align:left; vertical-align:middle; font-size:17px;"><span class="badge badge-primary stock1b1" name="stock_arr[]" id="stock_id'+product_id+'">'+stock+'</span><input type="hidden" class="form-control stock_c" name="stock_c_arr[]" id="stock_idd'+product_id+'" value="'+stock+'"> </td>'+
...
success:function(data){
  ...
  if (jQuery.inArray(data["pid"],productarr)!== -1) {
    ...
    function addrow(pid,product,saleprice,stock,barcode){
      ...
      '<td style="text-align:left; vertical-align:middle; font-size:17px;"><span class="badge badge-primary stock1b1" name="stock_arr[]" id="stock_id'+pid+'">'+stock+'</span><input type="hidden" class="form-control stock_c" name="stock_c_arr[]" id="stock_idd'+pid+'" value="'+stock+'"> </td>'+
...
if ((quantity.val()-0)>(tr.find(".stock_c").val()-0)) {
  ...
  Swal.fire("WARNING!" , "SORRY! This Much Of Is Not Available", "warning");
  quantity.val(1);
